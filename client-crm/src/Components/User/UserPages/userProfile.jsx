...
//         <div className="bg-gray-50 dark:bg-slate-800 shadow-2xl p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
...
//                 <h3 className="font-semibold text-lg text-[#ff8633]">Contact Information</h3>
