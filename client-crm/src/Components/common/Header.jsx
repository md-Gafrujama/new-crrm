...
// };
//     return (
//      <header className={`fixed top-0 left-0 right-0 z-50 flex h-[60px] items-center justify-between px-4 shadow-md transition-colors duration-200 dark:bg-slate-900 ${
